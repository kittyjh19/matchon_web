...
| 역할 | 이름 | 담당 |
|------|------|------|
| Backend | 홍주희 | 회원 관리, 메일 알림, 1:1 문의, AI 챗봇, 대회 일정 |
| Frontend | 팀원1 | 메인 페이지, 매치업 게시판 |
| Frontend | 팀원2 | 팀 관리, 커뮤니티 |
| Frontend | 팀원3 | 마이페이지, 관리자 페이지 |
| Frontend | 팀원4 | 실시간 채팅, 알림 |
